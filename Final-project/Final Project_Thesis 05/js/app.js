...
$('.circle-wrap').hover(function(event) { // this is what happens on mouseenter
	...
	var letter = event.target.children[0].classList[1];
	...
	var selectedClass2 = event.target.parentElement.classList[2];
...
// 	// pick out the x and y positions
// 	debugger
// 	var selectedClass = event.target.parentElement.parentElement.classList[2];
// 	console.log(selectedClass);
// 	if(selectedClass == 'a' || selectedClass == 'b') {
// 		$('.column1').addClass('colortemp--active');

// 	} else if(selectedClass == 'c' || selectedClass =='d'){
// 		$('.column2').addClass('colortemp--active');

// 	} else if(selectedClass == 'e' selectedClass =='f'){
// 		$('.column3').addClass('colortemp--active');

// 	} else if(selectedClass == 'g' selectedClass =='h'){
// 		$('.column4').addClass('colortemp--active');

// 	} else if(selectedClass == 'i' selectedClass =='j' ){
// 		$('.column5').addClass('colortemp--active');

// 	} else if(selectedClass == 'k' electedClass =='l'){
// 		$('.column6').addClass('colortemp--active');

// 	} else if(selectedClass == 'm' || selectedClass == 'n' ){
// 		$('.column7').addClass('colortemp--active');

// 	} else if(selectedClass == 'o' || selectedClass == 'p' ){
// 		$('.column8').addClass('colortemp--active');

// 	} else if(selectedClass == 'q' || selectedClass == 'r' ){
// 		$('.column9').addClass('colortemp--active');
